...
namespace CIS153_FinalProject.Forms {
    public partial class EndScreen : Form {
        ...
        public EndScreen(Window controller, int winner, string winnerName) { // Pass an int for whoever has won the game, 0 = p1 win, 1 = p2 win, 2 = draw, 3 = NO WINNER TO BE ASSIGNED AKA 2 PLAYER GAME
            InitializeComponent();
            windowController = controller;
            if (winner == 0) { // probably find a better way 
